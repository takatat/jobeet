...
CREATE TABLE jobeet_category (id BIGINT AUTO_INCREMENT, created_at DATETIME, updated_at DATETIME, PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE jobeet_category_translation ADD FOREIGN KEY (id) REFERENCES jobeet_category(id) ON UPDATE CASCADE ON DELETE CASCADE;
